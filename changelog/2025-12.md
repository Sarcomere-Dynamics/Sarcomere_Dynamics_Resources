...
This update is **NOT** being pushed to PIP until everything has made the switch over to the new API and the software is more stable. Therefore, latest repo must be pulled at all times.
