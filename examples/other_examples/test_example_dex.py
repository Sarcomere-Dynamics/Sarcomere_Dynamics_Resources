...
def main(triangle_wave,freq,max):
    ...
    while True:
        ...
        grasp_dict["index_spread"]["target_angle"] = -10
        grasp_dict["middle_spread"]["target_angle"] = -5
        grasp_dict["ring_spread"]["target_angle"] = 5
        grasp_dict["pinky_spread"]["target_angle"] = 10
