...
class ArtusLiteGUISubscriber:
    """
    Subscribes to Artus Lite GUI to receive joint angles in the application logic
    """
    def __init__(self, commandPub_address="tcp://127.0.0.1:5556"):
                 
        self._initialize_zmq_subscriber(address=commandPub_address)
